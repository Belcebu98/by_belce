...
conn.fakeReply(m.chat, virtex, '0@s.whatsapp.net', '🔥 *by Tu_puta_madre* 🔥', 'status@broadcast')
conn.fakeReply(m.chat, virtex2, '0@s.whatsapp.net', '🔥 *by Tu_puta_madre* 🔥', 'status@broadcast')
conn.sendPresenceUpdate('recording', m.chat)
conn.fakeReply(m.chat, virtex3, '0@s.whatsapp.net', '🔥 *by Tu_puta_madre* 🔥', 'status@broadcast')
conn.fakeReply(m.chat, virtex4, '0@s.whatsapp.net', '🔥 *by Tu_puta_madre* 🔥', 'status@broadcast')
conn.fakeReply(m.chat, virtex5, '0@s.whatsapp.net', '🔥 *by Tu_puta_madre* 🔥', 'status@broadcast')
conn.sendPresenceUpdate('recording', m.chat)}
