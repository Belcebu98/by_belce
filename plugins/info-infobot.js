...
╭━━━━[ ${gt} ]━━━━━⬣
┃
┃[🤴🏻] 𝘾𝙧𝙚𝙖𝙙𝙤𝙧: ℬℰℒ𝒞ℰℬ𝒪𝒯 𝒪ℱ𝒞
┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
┃[#️⃣] *𝘾𝙤𝙣𝙩𝙖𝙘𝙩𝙤:*  *wa.me/34637549064*
┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
┃[✅] *𝙑𝙚𝙧𝙨𝙞𝙤𝙣 𝙖𝙘𝙩𝙪𝙖𝙡:*  ${vs}
┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
┃ [🎳] *𝙋𝙧𝙚𝙛𝙞𝙟𝙤:* *${usedPrefix}*
...
conn.sendHydrated(m.chat, info, wm, pp, 'https://github.com/elrebelde21/The-LoliBot-MD', 'ℬℰℒ𝒞ℰℬ𝒪𝒯 𝒪ℱ𝒞', null, null, [
['𝙈𝙚𝙣𝙪́ 𝙘𝙤𝙢𝙥𝙡𝙚𝙩𝙤 ✨', '#menu'],
['𝘼𝙪𝙙𝙞𝙤𝙨 🔰', '/audios'],
], m,)
